...
--emptyConfigurations :: TestTree
--emptyConfigurations = testGroup "Configuration declaration unit"
--   [ compareFunc "No statement part, no label" False False
--   , compareFunc "Statement part, no label" True False
--   , compareFunc "No statement part, label" False True
--   , compareFunc "Statement part, label" True True
...
--                        PosnWrapper { unPos =
--                           Library_PrimaryUnit
--                              ( PrimaryUnit_ConfigurationDeclaration
--                                 PosnWrapper { unPos = identifier }
--                                 PosnWrapper { unPos = name1 }
--                                 []
--                                 PosnWrapper { unPos =
--                                    BlockConfiguration
--                                       PosnWrapper { unPos = BlockSpecification_Name archName }
--                                       []
--                                       []
--                                 }
--                                 wrappedName2
